  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="mx-auto max-w-4xl space-y-8">
        <div>
          <h1 className="text-3xl font-semibold mb-2">Button Centering Storyboard</h1>
          <p className="text-muted-foreground">
            Different approaches to center the Sparkles icon in the circular button. Hover over each button to see it
            expand.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="space-y-3">
            <h3 className="font-medium">1. Current (flex + conditional padding)</h3>
            <button
              ...
              style={{ width: hoveredButton === 1 ? "152px" : "32px", padding: hoveredButton === 1 ? "0 12px" : "0" }}
              onMouseEnter={() => setHoveredButton(1)}
              onMouseLeave={() => setHoveredButton(null)}
            >
              <Sparkles className="h-4 w-4 shrink-0" style={{ marginRight: hoveredButton === 1 ? "8px" : "0" }} />
              <span
          ...
          <div className="space-y-3">
            <h3 className="font-medium">2. Pure flex (no Tailwind utilities)</h3>
            <button
            ...
            >
              <Sparkles
                ...
                style={{ marginRight: hoveredButton === 2 ? "8px" : "0", transition: "margin 700ms ease-in-out" }}
              />
              <span
                className="whitespace-nowrap text-sm font-medium"
                style={{ opacity: hoveredButton === 2 ? 1 : 0, transition: "opacity 700ms ease-in-out" }}
              >
                Propose Action
              </span>
            </button>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              style={{ width: hoveredButton === 3 ? "152px" : "32px", padding: hoveredButton === 3 ? "0 12px" : "0" }}
            ...
            >
              <div className="flex items-center">
                <Sparkles
                  className="h-4 w-4 shrink-0"
                  style={{ marginRight: hoveredButton === 3 ? "8px" : "0", transition: "margin 700ms ease-in-out" }}
                />
                <span
                  className="whitespace-nowrap text-sm font-medium"
                  style={{ opacity: hoveredButton === 3 ? 1 : 0, transition: "opacity 700ms ease-in-out" }}
                >
                  Propose Action
                </span>
              </div>
            ...
            >
              <Sparkles
                ...
                style={{
                  ...
                  transform: hoveredButton === 4 ? "translateY(-50%)" : "translate(-50%, -50%)",
                }}
              />
              <span
          ...
          <div className="space-y-3">
            ...
            <button
              className="flex items-center justify-center h-8 rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white transition-all duration-700 ease-in-out overflow-hidden"
              style={{ width: hoveredButton === 5 ? "152px" : "32px", padding: hoveredButton === 5 ? "0 12px" : "0" }}
            ...
            >
              <div className="flex items-center justify-center">
                <Sparkles
                  className="h-4 w-4 shrink-0"
                  style={{ marginRight: hoveredButton === 5 ? "8px" : "0", transition: "margin 700ms ease-in-out" }}
                />
                <span
                  className="whitespace-nowrap text-sm font-medium"
                  style={{ opacity: hoveredButton === 5 ? 1 : 0, transition: "opacity 700ms ease-in-out" }}
                >
                  Propose Action
                </span>
              </div>
          ...
          <div className="space-y-3">
            ...
            >
              <Sparkles
                className="h-4 w-4 shrink-0"
                style={{ marginRight: hoveredButton === 6 ? "8px" : "0", transition: "margin 700ms ease-in-out" }}
              />
              <span
                className="whitespace-nowrap text-sm font-medium"
                style={{ opacity: hoveredButton === 6 ? 1 : 0, transition: "opacity 700ms ease-in-out" }}
              >
                Propose Action
              </span>
            </button>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              style={{ width: hoveredButton === 7 ? "152px" : "32px", padding: hoveredButton === 7 ? "0 12px" : "0" }}
              onMouseEnter={() => setHoveredButton(7)}
              onMouseLeave={() => setHoveredButton(null)}
            >
              <Sparkles
                className="h-4 w-4 shrink-0"
                style={{ marginRight: hoveredButton === 7 ? "8px" : "0", transition: "margin 700ms ease-in-out" }}
              />
              <span
                className="whitespace-nowrap text-sm font-medium"
                style={{ opacity: hoveredButton === 7 ? 1 : 0, transition: "opacity 700ms ease-in-out" }}
              >
                Propose Action
              </span>
            </button>
          ...
          <div className="space-y-3">
            ...
            <button
              className="flex items-center justify-center h-8 rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white transition-all duration-700 ease-in-out overflow-hidden"
              style={{ width: hoveredButton === 8 ? "152px" : "32px", padding: hoveredButton === 8 ? "0 12px" : "0" }}
            ...
            >
              ...
              <span
                className="whitespace-nowrap text-sm font-medium"
                style={{ opacity: hoveredButton === 8 ? 1 : 0, transition: "opacity 700ms ease-in-out" }}
              >
                Propose Action
              </span>
            </button>
